...
public class AuthController {
    ...
    public ResponseEntity<AuthDtos.AuthResponse> register(@Valid @RequestBody AuthDtos.RegisterCitizenRequest req) {
        return ResponseEntity.ok(authService.registerCitizen(req));
    }
